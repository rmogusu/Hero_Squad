...
public class Sql2oSquadDao implements SquadDao{
    ...
    public void add(Squad squad) {
        String sql = "INSERT INTO squads (name,max_size,cause) VALUES ('Super',10,'Fight sexism')";
    ...
    @Override
    public void update(int id, String newName, int newMax_size,String newCause) {
        String sql = "UPDATE squads SET name = :name, max_size = :max_size, cause =:cause WHERE id = :id";
        try (Connection con = sql2o.open()) {
            con.createQuery(sql)
                    .addParameter("name", newName)
                    .addParameter("max_size", newMax_size)
